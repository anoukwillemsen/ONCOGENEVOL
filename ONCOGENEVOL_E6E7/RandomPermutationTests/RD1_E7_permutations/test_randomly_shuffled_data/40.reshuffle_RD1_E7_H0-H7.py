...
idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77"]]
...
# blue-yellow-red-black-green
    idx = [seqnames.index(i) for i in ["BPV8", "CdPV2", "EcPV4", "EcPV6", "OaPV2", "OvPV1", "CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1", "AgPV1", "HPV32", "HPV70", "HPV77", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"
]]
...
# yellow-red-black-green
    idx = [seqnames.index(i) for i in ["CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1", "AgPV1", "HPV32", "HPV70", "HPV77", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# red-black-green
    idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# red-black
    idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77", "TmPV2", "TmPV3", "TmPV1", "TmPV4"]]
