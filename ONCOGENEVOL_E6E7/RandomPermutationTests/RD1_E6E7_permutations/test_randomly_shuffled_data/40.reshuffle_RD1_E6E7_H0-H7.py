...
align_ALL = AlignIO.read (filename, "phylip")
...
idx = [seqnames.index(i) for i in ["BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
align_fix2 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])  # BetaGamma
idx = [seqnames.index(i) for i in ["CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1"]]
...
idx = [seqnames.index(i) for i in ["BPV8", "CdPV2", "EcPV4", "EcPV6", "OaPV2", "OvPV1"]]
align_fix5 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])  # PerissoArtio
idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77", "MrPV1", "PphPV4"]]
...
# blue-yellow-red-black-green
    idx = [seqnames.index(i) for i in ["BPV8", "CdPV2", "EcPV4", "EcPV6", "OaPV2", "OvPV1", "CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1", "AgPV1", "HPV32", "HPV70", "HPV77", "MrPV1", "PphPV4", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# yellow-red-black-green
    idx = [seqnames.index(i) for i in ["CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1", "AgPV1", "HPV32", "HPV70", "HPV77", "MrPV1", "PphPV4", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# red-black-green
    idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77", "MrPV1", "PphPV4", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# black-green
    idx = [seqnames.index(i) for i in ["TmPV2", "TmPV3", "TmPV1", "TmPV4", "BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1"]]
...
# red-black
    idx = [seqnames.index(i) for i in ["AgPV1", "HPV32", "HPV70", "HPV77", "MrPV1", "PphPV4", "TmPV2", "TmPV3", "TmPV1", "TmPV4"]]
...
# green-yellow
    idx = [seqnames.index(i) for i in ["BpPV1", "FcaPV4", "HPV107", "HPV133", "RtiPV1", "VvPV1", "CPV1", "EhPV1", "ElPV1", "EsPV3", "PlpPV1", "SfPV1"]]
