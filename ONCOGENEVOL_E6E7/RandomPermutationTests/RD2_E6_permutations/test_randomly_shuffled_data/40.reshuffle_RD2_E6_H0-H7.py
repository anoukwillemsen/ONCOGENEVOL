...
idx = [seqnames.index(i) for i in ["CcPV1", "CmPV1", "FcPV1", "FgPV1", "FlPV1", "PaPV1"]]
...
idx = [seqnames.index(i) for i in ["HPV42", "HPV59", "HPV78", "SsPV1", "SscPV3", "UmPV1"]]
...
# blue-yellow-red-black-green
    idx = [seqnames.index(i) for i in ["CdPV1", "CePV2", "EcPV1", "EcPV2", "OaPV1", "OvPV1", "CPV6", "FcaPV1", "MscPV2", "OcPV1", "RfPV1", "TePV1", "HPV42", "HPV59", "HPV78", "SsPV1", "SscPV3", "UmPV1", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "ChPV1", "EePV1", "FcaPV3", "HPV123", "MfPV2", "VvPV1"]]
...
# yellow-red-black-green
    idx = [seqnames.index(i) for i in ["CPV6", "FcaPV1", "MscPV2", "OcPV1", "RfPV1", "TePV1", "HPV42", "HPV59", "HPV78", "SsPV1", "SscPV3", "UmPV1", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "ChPV1", "EePV1", "FcaPV3", "HPV123", "MfPV2", "VvPV1"]]
...
# red-black-green
    idx = [seqnames.index(i) for i in ["HPV42", "HPV59", "HPV78", "SsPV1", "SscPV3", "UmPV1", "TmPV2", "TmPV3", "TmPV1", "TmPV4", "ChPV1", "EePV1", "FcaPV3", "HPV123", "MfPV2", "VvPV1"]]
...
# red-black
    idx = [seqnames.index(i) for i in ["HPV42", "HPV59", "HPV78", "SsPV1", "SscPV3", "UmPV1", "TmPV2", "TmPV3", "TmPV1", "TmPV4"]]
