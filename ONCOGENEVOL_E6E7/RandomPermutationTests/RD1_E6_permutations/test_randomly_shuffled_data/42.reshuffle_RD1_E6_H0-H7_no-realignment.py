...
os.chdir ("./tmp." + suffix)
outfile = open ("table_LnL_no-realignment.txt", "w", 0)
...
# blue-yellow-red-black-green
    idx = [seqnames.index(i) for i in ["BpPV1", "HPV107", "RtiPV1", "FcaPV4", "VvPV1", "HPV133", "EsPV3", "EhPV1", "SfPV1", "ElPV1", "CPV1", "PlpPV1", "TmPV2", "TmPV3", "TmPV4", "TmPV1", "BPV8", "CdPV2", "OaPV2", "OvPV1", "EcPV6", "EcPV4", "PphPV4", "MrPV1", "AgPV1", "HPV77", "HPV32", "HPV70"]]
...
# yellow-red-black-green
    idx = [seqnames.index(i) for i in ["BpPV1", "HPV107", "RtiPV1", "FcaPV4", "VvPV1", "HPV133", "EsPV3", "EhPV1", "SfPV1", "ElPV1", "CPV1", "PlpPV1", "TmPV2", "TmPV3", "TmPV4", "TmPV1", "PphPV4", "MrPV1", "AgPV1", "HPV77", "HPV32", "HPV70"]]
...
# red-black-green
    idx = [seqnames.index(i) for i in ["BpPV1", "HPV107", "RtiPV1", "FcaPV4", "VvPV1", "HPV133", "TmPV2", "TmPV3", "TmPV4", "TmPV1", "PphPV4", "MrPV1", "AgPV1", "HPV77", "HPV32", "HPV70"]]
...
# black-green
    idx = [seqnames.index(i) for i in ["BpPV1", "HPV107", "RtiPV1", "FcaPV4", "VvPV1", "HPV133", "TmPV2", "TmPV3", "TmPV4", "TmPV1"]]
...
# red-black
    idx = [seqnames.index(i) for i in ["PphPV4", "MrPV1", "AgPV1", "HPV77", "HPV32", "HPV70", "TmPV2", "TmPV3", "TmPV4", "TmPV1"]]
...
# green-yellow
    idx = [seqnames.index(i) for i in ["BpPV1", "HPV107", "RtiPV1", "FcaPV4", "VvPV1", "HPV133", "EsPV3", "EhPV1", "SfPV1", "ElPV1", "CPV1", "PlpPV1"]]
...
outfile.close()
os.system ("mv table_LnL_no-realignment.txt ../tableLnL_no-realignment_" + suffix + ".txt")
os.chdir  ("../")
