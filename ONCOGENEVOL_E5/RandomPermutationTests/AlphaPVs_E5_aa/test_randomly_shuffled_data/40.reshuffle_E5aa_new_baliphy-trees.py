...
#   alpha1-alpha2
    ...
    strout_H1, gamma, lnl_H1 = phyml_ml ("c50.PP.alpha1-alpha2.tree")
    str_out += strout_H1
    model_out += gamma
    lnl_out += lnl_H1 + " "
...
#   gammadelta-delta
    ...
    strout_H2, gamma, lnl_H2 = phyml_ml ("c50.PP.gammadelta-delta.tree")
    str_out += strout_H2
    model_out += gamma
    lnl_out += lnl_H2 + " "
...
#   alpha1-alpha2-gammadelta-delta
    ...
    strout_H3, gamma, lnl_H3 = phyml_ml ("c50.PP.alpha1-alpha2-gammadelta-delta.tree")
    str_out += strout_H3
    model_out += gamma
    lnl_out += lnl_H3 + " "
...
#   alpha1-alpha2-gammadelta-delta-epsilonzeta
    ...
    strout_H4, gamma, lnl_H4 = phyml_ml ("c50.PP.alpha1-alpha2-gammadelta-delta-epsilonzeta.tree")
    str_out += strout_H4
    model_out += gamma
    lnl_out += lnl_H4 + " "
...
#   alpha1-alpha2-epsilonzeta
    ...
    strout_H5, gamma, lnl_H5 = phyml_ml ("c50.PP.alpha1-alpha2-epsilonzeta.tree")
    str_out += strout_H5
    model_out += gamma
    lnl_out += lnl_H5 + " "
