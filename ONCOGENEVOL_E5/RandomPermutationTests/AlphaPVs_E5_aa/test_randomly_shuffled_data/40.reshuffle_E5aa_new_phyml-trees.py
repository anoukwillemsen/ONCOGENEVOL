...
idx = [seqnames.index(i) for i in ["MUC_HPV18_E5_ALPHA1", "MUC_HPV39_E5_ALPHA1", "MUC_HPV45_E5_ALPHA1", "MUC_HPV59_E5_ALPHA1", "MUC_HPV68_E5_ALPHA1", "MUC_HPV70_E5_ALPHA1", "MUC_HPV85_E5_ALPHA1", "MUC_HPV97_E5_ALPHA1"]]
align_fix1 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx]) #alpha1
idx = [seqnames.index(i) for i in ["MUC_HPV16_E5_ALPHA2", "MUC_HPV31_E5_ALPHA2", "MUC_HPV33_E5_ALPHA2", "MUC_HPV34_E5_ALPHA2", "MUC_HPV35_E5_ALPHA2", "MUC_HPV52_E5_ALPHA2", "MUC_HPV58_E5_ALPHA2", "MUC_HPV67_E5_ALPHA2", "MUC_HPV73_E5_ALPHA2"]]
align_fix2 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])  #alpha2
idx = [seqnames.index(i) for i in ["CUT_CgPV1_E5_BETA", "CUT_HPV2_E5_BETA", "CUT_HPV3_E5_BETA", "CUT_HPV10_E5_BETA", "CUT_HPV27_E5_BETA", "CUT_HPV28_E5_BETA", "CUT_HPV29_E5_BETA", "CUT_HPV57_E5_BETA", "CUT_HPV61_E5_BETA", "CUT_HPV62_E5_BETA", "CUT_HPV71_E5_BETA", "CUT_HPV72_E5_BETA", "CUT_HPV77_E5_BETA", "CUT_HPV78_E5_BETA", "CUT_HPV81_E5_BETA", "CUT_HPV83_E5_BETA", "CUT_HPV84_E5_BETA", "CUT_HPV86_E5_BETA", "CUT_HPV87_E5_BETA", "CUT_HPV89_E5_BETA", "CUT_HPV90_E5_BETA", "CUT_HPV94_E5_BETA", "CUT_HPV102_E5_BETA", "CUT_HPV106_E5_BETA", "CUT_HPV114_E5_BETA", "CUT_HPV117_E5_BETA", "CUT_HPV125_E5_BETA", "CUT_HPV160_E5_BETA"]]
align_fix3 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])  #beta
idx = [seqnames.index(i) for i in ["GW_HPV6_E5_GAMMA_DELTA", "GW_HPV11_E5_GAMMA_DELTA", "GW_HPV13_E5_GAMMA_DELTA", "GW_HPV44_E5_GAMMA_DELTA", "GW_HPV74_E5_GAMMA_DELTA", "GW_PpPV1_E5_GAMMA_DELTA", "GW_CchPV1_E5_GAMMA_DELTA"]]
...
idx = [seqnames.index(i) for i in ["MUC_MfPV3_E5_EPSILON_DSETA", "MUC_MfPV4_E5_EPSILON_DSETA", "MUC_MfPV5_E5_EPSILON_DSETA", "MUC_MfPV6_E5_EPSILON_DSETA", "MUC_MfPV7_E5_EPSILON_DSETA", "MUC_MfPV8_E5_EPSILON_DSETA", "MUC_MfPV9_E5_EPSILON_DSETA", "MUC_MfPV10_E5_EPSILON_DSETA", "MUC_MfPV11_E5_EPSILON_DSETA", "MUC_MfuPV1_E5_EPSILON_DSETA", "MUC_MmPV1_E5_EPSILON_DSETA", "MUC_PhPV1_E5_EPSILON_DSETA"]]
...
for iteration in range (n_iters):
    ...
    strout_alpha1, gamma, lnl_alpha1 = phyml_ml ("original_alpha1.phy_phyml_tree")
    ...
    strout_alpha2, gamma, lnl_alpha2 = phyml_ml ("original_alpha2.phy_phyml_tree")
    ...
    strout_beta, gamma, lnl_beta = phyml_ml ("original_beta.phy_phyml_tree")
    str_out += strout_beta
    model_out += gamma
    lnl_out += lnl_beta + " "
    ...
    strout_gammadelta, gamma, lnl_gammadelta = phyml_ml ("original_gammadelta.phy_phyml_tree")
    ...
    strout_delta, gamma, lnl_delta = phyml_ml ("original_delta.phy_phyml_tree")
    ...
    strout_epsilonzeta, gamma, lnl_epsilonzeta = phyml_ml ("original_epsilonzeta.phy_phyml_tree")
...
#   alpha1-alpha2
    idx = [seqnames.index(i) for i in ["MUC_HPV18_E5_ALPHA1", "MUC_HPV39_E5_ALPHA1", "MUC_HPV45_E5_ALPHA1", "MUC_HPV59_E5_ALPHA1", "MUC_HPV68_E5_ALPHA1", "MUC_HPV70_E5_ALPHA1", "MUC_HPV85_E5_ALPHA1", "MUC_HPV97_E5_ALPHA1", "MUC_HPV16_E5_ALPHA2", "MUC_HPV31_E5_ALPHA2", "MUC_HPV33_E5_ALPHA2", "MUC_HPV34_E5_ALPHA2", "MUC_HPV35_E5_ALPHA2", "MUC_HPV52_E5_ALPHA2", "MUC_HPV58_E5_ALPHA2", "MUC_HPV67_E5_ALPHA2", "MUC_HPV73_E5_ALPHA2"]]
    align_H1 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx]) 
    write_to_phylip (align_H1, "mc.paml")
    strout_H1, gamma, lnl_H1 = phyml_ml ("original_alpha1-alpha2.phy_phyml_tree")
    str_out += strout_H1
    model_out += gamma
    lnl_out += lnl_H1 + " "

#   gammadelta-delta
    idx = [seqnames.index(i) for i in ["GW_HPV6_E5_GAMMA_DELTA", "GW_HPV11_E5_GAMMA_DELTA", "GW_HPV13_E5_GAMMA_DELTA", "GW_HPV44_E5_GAMMA_DELTA", "GW_HPV74_E5_GAMMA_DELTA", "GW_PpPV1_E5_GAMMA_DELTA", "GW_CchPV1_E5_GAMMA_DELTA", "GW_HPV7_E5_DELTA", "GW_HPV40_E5_DELTA", "GW_HPV43_E5_DELTA", "GW_HPV91_E5_DELTA"]]
    align_H2 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])
    write_to_phylip (align_H2, "mc.paml")
    strout_H2, gamma, lnl_H2 = phyml_ml ("original_gammadelta-delta.phy_phyml_tree")
    str_out += strout_H2
    model_out += gamma
    lnl_out += lnl_H2 + " "

#   alpha1-alpha2-gammadelta-delta
    idx = [seqnames.index(i) for i in ["MUC_HPV18_E5_ALPHA1", "MUC_HPV39_E5_ALPHA1", "MUC_HPV45_E5_ALPHA1", "MUC_HPV59_E5_ALPHA1", "MUC_HPV68_E5_ALPHA1", "MUC_HPV70_E5_ALPHA1", "MUC_HPV85_E5_ALPHA1", "MUC_HPV97_E5_ALPHA1", "MUC_HPV16_E5_ALPHA2", "MUC_HPV31_E5_ALPHA2", "MUC_HPV33_E5_ALPHA2", "MUC_HPV34_E5_ALPHA2", "MUC_HPV35_E5_ALPHA2", "MUC_HPV52_E5_ALPHA2", "MUC_HPV58_E5_ALPHA2", "MUC_HPV67_E5_ALPHA2", "MUC_HPV73_E5_ALPHA2", "GW_HPV6_E5_GAMMA_DELTA", "GW_HPV11_E5_GAMMA_DELTA", "GW_HPV13_E5_GAMMA_DELTA", "GW_HPV44_E5_GAMMA_DELTA", "GW_HPV74_E5_GAMMA_DELTA", "GW_PpPV1_E5_GAMMA_DELTA", "GW_CchPV1_E5_GAMMA_DELTA", "GW_HPV7_E5_DELTA", "GW_HPV40_E5_DELTA", "GW_HPV43_E5_DELTA", "GW_HPV91_E5_DELTA"]]
    align_H3 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])
    write_to_phylip (align_H3, "mc.paml")
    strout_H3, gamma, lnl_H3 = phyml_ml ("original_alpha1_alpha2_gammadelta-delta.phy_phyml_tree")
    str_out += strout_H3
    model_out += gamma
    lnl_out += lnl_H3 + " "

#   alpha1-alpha2-gammadelta-delta-epsilonzeta
    idx = [seqnames.index(i) for i in ["MUC_HPV18_E5_ALPHA1", "MUC_HPV39_E5_ALPHA1", "MUC_HPV45_E5_ALPHA1", "MUC_HPV59_E5_ALPHA1", "MUC_HPV68_E5_ALPHA1", "MUC_HPV70_E5_ALPHA1", "MUC_HPV85_E5_ALPHA1", "MUC_HPV97_E5_ALPHA1", "MUC_HPV16_E5_ALPHA2", "MUC_HPV31_E5_ALPHA2", "MUC_HPV33_E5_ALPHA2", "MUC_HPV34_E5_ALPHA2", "MUC_HPV35_E5_ALPHA2", "MUC_HPV52_E5_ALPHA2", "MUC_HPV58_E5_ALPHA2", "MUC_HPV67_E5_ALPHA2", "MUC_HPV73_E5_ALPHA2", "GW_HPV6_E5_GAMMA_DELTA", "GW_HPV11_E5_GAMMA_DELTA", "GW_HPV13_E5_GAMMA_DELTA", "GW_HPV44_E5_GAMMA_DELTA", "GW_HPV74_E5_GAMMA_DELTA", "GW_PpPV1_E5_GAMMA_DELTA", "GW_CchPV1_E5_GAMMA_DELTA", "GW_HPV7_E5_DELTA", "GW_HPV40_E5_DELTA", "GW_HPV43_E5_DELTA", "GW_HPV91_E5_DELTA", "MUC_MfPV3_E5_EPSILON_DSETA", "MUC_MfPV4_E5_EPSILON_DSETA", "MUC_MfPV5_E5_EPSILON_DSETA", "MUC_MfPV6_E5_EPSILON_DSETA", "MUC_MfPV7_E5_EPSILON_DSETA", "MUC_MfPV8_E5_EPSILON_DSETA", "MUC_MfPV9_E5_EPSILON_DSETA", "MUC_MfPV10_E5_EPSILON_DSETA", "MUC_MfPV11_E5_EPSILON_DSETA", "MUC_MfuPV1_E5_EPSILON_DSETA", "MUC_MmPV1_E5_EPSILON_DSETA", "MUC_PhPV1_E5_EPSILON_DSETA"]]
    align_H4 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx])
    write_to_phylip (align_H4, "mc.paml")
    strout_H4, gamma, lnl_H4 = phyml_ml ("original_alpha1-alpha2-gammadelta-delta-epsilonzeta.phy_phyml_tree")
    str_out += strout_H4
    model_out += gamma
    lnl_out += lnl_H4 + " "

#   alpha1-alpha2-epsilonzeta
    idx = [seqnames.index(i) for i in ["MUC_HPV18_E5_ALPHA1", "MUC_HPV39_E5_ALPHA1", "MUC_HPV45_E5_ALPHA1", "MUC_HPV59_E5_ALPHA1", "MUC_HPV68_E5_ALPHA1", "MUC_HPV70_E5_ALPHA1", "MUC_HPV85_E5_ALPHA1", "MUC_HPV97_E5_ALPHA1", "MUC_HPV16_E5_ALPHA2", "MUC_HPV31_E5_ALPHA2", "MUC_HPV33_E5_ALPHA2", "MUC_HPV34_E5_ALPHA2", "MUC_HPV35_E5_ALPHA2", "MUC_HPV52_E5_ALPHA2", "MUC_HPV58_E5_ALPHA2", "MUC_HPV67_E5_ALPHA2", "MUC_HPV73_E5_ALPHA2", "MUC_MfPV3_E5_EPSILON_DSETA", "MUC_MfPV4_E5_EPSILON_DSETA", "MUC_MfPV5_E5_EPSILON_DSETA", "MUC_MfPV6_E5_EPSILON_DSETA", "MUC_MfPV7_E5_EPSILON_DSETA", "MUC_MfPV8_E5_EPSILON_DSETA", "MUC_MfPV9_E5_EPSILON_DSETA", "MUC_MfPV10_E5_EPSILON_DSETA", "MUC_MfPV11_E5_EPSILON_DSETA", "MUC_MfuPV1_E5_EPSILON_DSETA", "MUC_MmPV1_E5_EPSILON_DSETA", "MUC_PhPV1_E5_EPSILON_DSETA"]]
    align_H5 = Align.MultipleSeqAlignment([align_ALL[i] for i in idx]) 
    write_to_phylip (align_H5, "mc.paml")
    strout_H5, gamma, lnl_H5 = phyml_ml ("original_alpha1-alpha2-epsilonzeta.phy_phyml_tree")
    str_out += strout_H5
    model_out += gamma
    lnl_out += lnl_H5 + " "
