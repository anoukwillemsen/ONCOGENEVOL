...
#   gammadelta-delta
    ...
    strout_H2, gamma, lnl_H2 = phyml_ml ("original_gammadelta_delta.phy_phyml_tree")
    str_out += strout_H2
    model_out += gamma
    lnl_out += lnl_H2 + " "
...
#   alpha1-alpha2-gammadelta-delta
    ...
    strout_H3, gamma, lnl_H3 = phyml_ml ("original_alpha1-alpha2-gammadelta-delta.phy_phyml_tree")
    str_out += strout_H3
    model_out += gamma
    lnl_out += lnl_H3 + " "
